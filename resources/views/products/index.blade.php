    ...
    <div class="container mx-auto px-4 py-12">
                ...
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    ...
                    <div class="relative">
                        <button type="button" @click="filterOpen = !filterOpen"
                            class="flex items-center gap-2 px-5 py-3 text-white bg-blue-400 rounded-lg hover:bg-blue-500 transition-colors shadow-md">
                        ...
                        <div x-show="filterOpen" @click.away="filterOpen = false" x-transition:enter="transition ease-out duration-200"
                            ...
                            <div class="p-6">
                                ...
                                <button type="submit"
                                    class="w-full py-3 bg-black text-white font-semibold rounded-lg hover:bg-blue-400 transition-colors">
                                    Použít filtr
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <select name="sort_by" id="sort_by"
                            class="p-2 border border-gray-300 rounded-lg bg-white focus:ring-2 focus:ring-blue-400 focus:border-blue-400"
        ...
        <div class="mb-6 flex flex-wrap gap-2">
            ...
            <span class="inline-flex items-center px-3 py-1 rounded-full text-sm bg-blue-100 text-blue-800">
                ...
                <a href="{{ request()->fullUrlWithQuery(['price_from' => 0]) }}" class="ml-1 text-blue-800 hover:text-blue-900">
            ...
            @if(request('category'))
                @foreach((array)request('category') as $categoryId)
                    ...
                    <span class="inline-flex items-center px-3 py-1 rounded-full text-sm bg-blue-100 text-blue-800">
                        ...
                        <a href="{{ request()->fullUrlWithQuery(['category' => array_diff((array)request('category'), [$categoryId])]) }}" class="ml-1 text-blue-800 hover:text-blue-900">
                            <x-heroicon-o-x-mark class="h-4 w-4" />
                        </a>
                    </span>
                    @endif
            ...
            <a href="{{ route('products.index') }}" class="text-sm text-black hover:text-blue-600 underline ml-2" style="font-family: NunitoLight;">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            <div class="group relative bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 flex flex-col h-full transform hover:-translate-y-1">
                ...
                <div class="absolute top-3 left-3 z-10">
                    <span class="inline-block bg-blue-400 text-black px-3 py-1 rounded-full text-xs font-bold" style="font-family: Nunito;">NOVINKA</span>
                </div>
                @endif
                ...
                <div class="relative overflow-hidden h-64">
                    ...
                    <div class="absolute inset-0 bg-black bg-opacity-20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                        <a href="{{ route('products.show', $product->id) }}"
                            class="bg-black text-white px-4 py-2 rounded-lg transform translate-y-4 hover:bg-blue-400 transition-color group-hover:translate-y-0 transition-transform duration-300"
                ...
                <div class="p-5 flex flex-col flex-grow">
                    <div class="mb-2 flex items-center">
                        <div class="flex">
                            @for($i = 1; $i <= 5; $i++)
                                @if($i <= round($product->averageRating()))
                                    <x-heroicon-s-star class="h-4 w-4 star-blue" />
                                @else
                        ...
                        <style>
                            .star-blue {
                                color: #FBBF24; /* Žlutá barva (Tailwind text-blue-400) */
                            }
                            .star-gray {
                    ...
                    <div class="mt-auto">
                        ...
                        <div class="flex space-x-2">
                            <a href="{{ route('products.show', $product->id) }}"
                                class="flex-1 bg-black text-white text-center py-2 rounded-lg hover:bg-blue-400 transition-colors"
                                style="font-family: Nunito;">
                                Detail
                            </a>
                            <!-- Add to Cart Button -->
                            <button type="button"
                                    class="bg-blue-400 text-white px-3 py-2 rounded-lg hover:bg-blue-500 transition-colors"
        ...
        <div class="text-center py-16">
            ...
            <a href="{{ route('products.index') }}" class="inline-block bg-blue-400 text-black px-6 py-3 rounded-lg font-semibold hover:bg-blue-500 transition-colors" style="font-family: Nunito;">
        ...
        <div class="text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-3">
                ...
                <a href="{{ route('cart.index') }}"
                    class="flex-1 bg-blue-400 text-white py-2 rounded-lg hover:bg-blue-500 transition-colors text-center"
                    style="font-family: Nunito;">
                    Přejít do košíku
                </a>
            </div>
