...
<div class="bg-gray-50 min-h-screen pt-20">
    ...
    <div class="container mx-auto px-4 py-8">
        <!-- Back Button -->
        <div class="mb-6">
            <a href="{{ route('products.index') }}" class="inline-flex items-center text-black hover:text-blue-600 transition-colors">
            ...
            <div class="flex flex-col lg:flex-row">
                ...
                <div class="w-full lg:w-1/2 p-6 lg:p-8 bg-black">
                    ...
                    <div class="relative px-8">
                        <button id="prev-image" class="absolute left-0 top-1/2 transform -translate-y-1/2 bg-blue-400 text-black p-2 rounded-full hover:bg-blue-500 transition-colors z-10">
                                ...
                                @foreach ($product->images as $index => $image)
                                    <div class="flex-shrink-0" style="width: 80px;">
                                        <img src="{{ asset('storage/' . $image) }}"
                                            alt="{{ $product->name }}"
                                            class="w-20 h-20 object-cover rounded-lg cursor-pointer image-thumbnail {{ $index === 0 ? 'ring-2 ring-blue-400' : '' }}"
                                            data-index="{{ $index }}">
                                    </div>
                                @endforeach
                            </div>
                        ...
                        <button id="next-image" class="absolute right-0 top-1/2 transform -translate-y-1/2 bg-blue-400 text-black p-2 rounded-full hover:bg-blue-500 transition-colors z-10">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="flex items-center mb-6">
                                ...
                                @if(isset($product->old_price) && $product->old_price > $product->price)
                                    ...
                                    <span class="ml-3 bg-blue-400 text-black px-2 py-1 rounded-md text-sm font-bold">
                            ...
                            <div class="flex items-center">
                                ...
                                <span class="text-sm text-gray-600" style="font-family: NunitoLight;">
                                    ...
                                    @elseif($product->in_stock > 0)
                                        <span class="text-blue-600">Poslední kusy ({{ $product->in_stock }} ks)</span>
                                    @else
                        ...
                        <div class="mt-auto">
                            ...
                            <div class="flex space-x-4">
                                <button type="button"
                                    ...
                                    class="flex-1 bg-blue-400 hover:bg-blue-500 text-white font-bold py-3 px-6 rounded-lg transition-colors flex items-center justify-center"
...
<div class="mt-12">
    <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
        <div class="p-6 lg:p-8">
            <h2 class="text-2xl font-bold mb-6 flex items-center" style="font-family: BebasNeue;">
                <x-heroicon-s-star class="h-6 w-6 mr-2 text-blue-400" />
                HODNOCENÍ ZÁKAZNÍKŮ
            </h2>
    ...
    <div class="w-full md:w-1/3 flex flex-col items-center justify-center">
            ...
            @endfor
                                ...
                                <div class="flex items-center mb-2">
                                    ...
                                    <div class="flex-1 mx-4">
                                        <div class="h-3 bg-gray-200 rounded-full overflow-hidden">
                                            <div class="h-full bg-blue-400 rounded-full" style="width: {{ ($ratingCounts[$i-1] / $totalReviews) * 100 }}%"></div>
                                        </div>
                                    </div>
                                ...
                                <div class="border-b border-gray-200 pb-6 last:border-b-0">
                                    <div class="flex items-center mb-2">
                                        <div class="w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center mr-3">
                                            <span class="text-blue-600 font-bold" style="font-family: Nunito;">
                            ...
                            <div class="mt-8 pt-8 border-t border-gray-200">
                                ...
                                <form action="{{ route('reviews.store') }}" method="POST">
                                        ...
                                        <div class="flex items-center rating-input">
                                            @for($i = 1; $i <= 5; $i++)
                                                <label class="cursor-pointer p-1">
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-gray-300 hover:text-blue-400 transition-colors star-icon" viewBox="0 0 20 20" fill="currentColor">
                                                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                                    </svg>
                                                </label>
                                            @endfor
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea name="comment" id="comment" rows="4" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent" style="font-family: NunitoLight;"></textarea>
                                    </div>

                                    <button type="submit" class="bg-black text-white py-2 px-6 rounded-lg hover:bg-blue-400 transition-colors" style="font-family: Nunito;">
                                        Odeslat recenzi
                                    </button>
                                </form>
                            </div>
                    ...
                    @else
                        <div class="mt-8 p-6 bg-gray-50 rounded-lg text-center">
                            ...
                            <a href="{{ route('login') }}" class="inline-block bg-black text-white py-2 px-6 rounded-lg hover:bg-blue-400 transition-colors" style="font-family: Nunito;">
                                Přihlásit se
                            </a>
                        </div>
                    @endauth
        ...
        <div class="mt-12">
            <h2 class="text-2xl font-bold mb-6 flex items-center" style="font-family: BebasNeue;">
                <x-heroicon-o-squares-2x2 class="h-6 w-6 mr-2 text-blue-400" />
                        ...
                        <div class="p-4 flex flex-col flex-grow">
                            ...
                            <div class="mt-auto">
                                ...
                                <a href="{{ route('products.show', $relatedProduct->id) }}"
                                    class="block w-full bg-black text-white text-center py-2 rounded-lg hover:bg-blue-400 transition-colors"
                                    style="font-family: Nunito;">
                                    Zobrazit detail
                                </a>
                            </div>
...
<div id="confirmation-box-{{ $product->id }}" class="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center hidden">
    <div class="bg-white rounded-xl shadow-2xl p-6 max-w-md w-full mx-4 transform transition-all">
        <div class="text-center">
            ...
            <x-heroicon-o-check class="h-8 w-8 text-blue-500" />
            </div>
            ...
            <div class="flex flex-col sm:flex-row gap-3">
                ...
                <form action="{{ route('cart.add', ['productId' => $product->id]) }}" method="POST" class="flex-1">
                    ...
                    <button type="submit"
                        class="w-full bg-blue-400 text-white py-3 px-4 rounded-lg hover:bg-blue-500 transition-colors font-bold"
                        style="font-family: Nunito;">
                        Přejít do košíku
                    </button>
                </form>
        ...
        ratingContainer.addEventListener('mouseleave', function() {
            ...
            if (selectedRating) {
                ...
                starIcons.forEach((star, i) => {
                    if (i <= selectedIndex) {
                        star.classList.add('text-blue-400');
                        star.classList.remove('text-gray-300');
                    } else {
                        star.classList.remove('text-blue-400');
